...
extension SearchPageDTO {
    /// Lenient like the app's other mappers: absent optionals get
    /// zero-values, unparseable dates become nil.
...
/// Parses TMDB's `yyyy-MM-dd` dates. (Feature-local twin — Data-layer
/// helpers stay inside their feature.)
enum TMDBDateParser {
